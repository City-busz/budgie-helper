...
output_get_presentation_xrandr (FlashbackMonitorManagerPrivate *priv,
                                MetaOutput                     *output)
{
  return output_get_boolean_property (priv, output, "_BUDGIE_HELPER_PRESENTATION_OUTPUT");
}
                                ...
                                gboolean                        presentation)
{
  ...
  value = presentation;
  atom = XInternAtom (priv->xdisplay, "_BUDGIE_HELPER_PRESENTATION_OUTPUT", False);
